...
namespace Tiquicia_Lodge.Controllers
{
    ...
    public class ProvinciasController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<Provincias>> Get(int id)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<Provincias>> Post([FromBody] Provincias entity)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(int id, [FromBody] Provincias entity)
        {
